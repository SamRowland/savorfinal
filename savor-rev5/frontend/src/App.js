...
function App() {
  ...
  const Profile = () => {
    ...
    const loadUserRecipes = () => {      
      ...
      let recipeDeleteButtonDiv = document.createElement("div");
      recipeDeleteButtonDiv.innerHTML = `<button class="btn btn-danger" type="button">Delete Recipe</button>`;
      recipeDeleteButtonDiv.addEventListener("click", function(){deleteRecipe(curRecipe._id)});
      recipeContainer.appendChild(recipeCard);
      recipeContainer.appendChild(recipeDeleteButtonDiv);
